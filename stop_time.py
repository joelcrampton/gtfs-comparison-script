...
class StopTime:
    ...
    start_pickup_drop_off_window: time # Conditionally Required
    end_pickup_drop_off_window: time # Conditionally Required
    ...
    def from_series(self, row: pd.Series):
        ...
        arrival_time = adjust_time(row.get('arrival_time')) if not pd.isna(row.get('arrival_time')) else None
        departure_time = adjust_time(row.get('departure_time')) if not pd.isna(row.get('departure_time')) else None
        ...
        start_pickup_drop_off_window = adjust_time(row.get('start_pickup_drop_off_window')) if not pd.isna(row.get('start_pickup_drop_off_window')) else None
        end_pickup_drop_off_window = adjust_time(row.get('end_pickup_drop_off_window')) if not pd.isna(row.get('end_pickup_drop_off_window')) else None
